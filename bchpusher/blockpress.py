...
def set_name(PrivateKey, new_name, fee=1):
    ...
    return bchpusher.bitpush(PrivateKey, lst_of_pushdata, fee=1)
...
"""
more functions to go here... until blockpress fix their syncing scrypt I see no point in continuing...
"""
